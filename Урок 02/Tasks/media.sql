...
CREATE TABLE `storage` (
  ...
  `user_name` varchar(255) DEFAULT NULL COMMENT 'Имя пользователя',
  `file_name` varchar(255) DEFAULT NULL COMMENT 'Имя файла',
  `file_path` varchar(255) DEFAULT NULL COMMENT 'Путь до файла',
  `file_descr` varchar(255) DEFAULT NULL COMMENT 'Описание файла',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
...
-- Dump completed on 2021-02-20  2:45:27
